...
@TemplateRegistrations({
    ...
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "backupscriptmysql", content = "templates/backupscriptmysql.template", scriptEngine = "freemarker"),
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "createmysqldatabase", content = "templates/createmysqldatabase.template", scriptEngine = "freemarker"),
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "createmysqltables", content = "templates/createmysqltables.template", scriptEngine = "freemarker"),
    ...
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "tablemodel", content = "templates/tablemodel.template", scriptEngine = "freemarker"),
    ...
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "mysql", content = "templates/mysql.template", scriptEngine = "freemarker"),
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "restcreator", content = "templates/restcreator.template", scriptEngine = "freemarker"),
    ...
    @TemplateRegistration(folder = "uk-theretiredprogrammer-nbpcg", displayName = "action", content = "templates/action.template", scriptEngine = "freemarker"),
