 ...
 */
public class OtherNode extends FilterNode {

    @StaticResource
    private static final String IMAGE = "linsdale/nbpcg/basicproject/others.gif";

    public OtherNode(Project proj) throws DataObjectNotFoundException {
